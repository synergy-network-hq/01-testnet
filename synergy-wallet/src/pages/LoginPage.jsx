...
export default function LoginPage({ onWalletCreated }) {
  ...
  const renderPassphraseStep = () => (
    <div>
      ...
      <div style={{ backgroundColor: "#fff3cd", display: "flex", alignItems: "center", width: 614, padding: "4px", borderRadius: "8px", marginBottom: "16px", border: "1.5px solidrgba(255, 234, 167, 0.83)" }}>
        <p style={{ margin: "0 5px", padding: 0, fontSize: "30px", color: "#856404" }}>⚠️</p>
        <p style={{ margin: 0, padding: 0, fontSize: "14px", color: "#856404" }}>
  ...
  const renderBackupPlanStep = () => (
    <div>
      <h3 style={{ textAlign: "center" }}>Backup & Recovery Plan</h3>
  ...
  return (
    <div className="container" style={{ background: "var(--bg)" }}>
      <div className="content" style={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "100vh", background: "var(--bg)" }}>
        <section className="section dashboard-card" style={{ maxWidth: "1000px", width: "100%" }}>
          <h1 className="h1 inlineStyle84" style={{ textAlign: "center" }}>Synergy Wallet</h1>
          <p style={{ textAlign: "center", fontSize: "18px", color: "var(--text-muted)" }}>
          ...
          <div style={{ width: "600px", padding: 20, margin: "0 auto", minHeight: "500px", display: "flex", flexDirection: "column" }}>
            <div style={{ flex: 1 }}>
              {renderCurrentStep()}
            </div>
            {step !== Steps.MODE && step !== Steps.COMPLETE && (
              <div style={{ marginTop: "auto", paddingTop: "20px" }}>
                ...
                <div style={{
                  display: "flex",
                  gap: "12px",
                  justifyContent: step === Steps.CREATE_CHOOSE_LENGTH || step === Steps.IMPORT_CHOOSE_LENGTH ? "center" : "space-between",
                  marginTop: "24px"
                }}>
                  <button
                    className="sidebar-button"
                  ...
                  >
                    {step === Steps.CREATE_CHOOSE_LENGTH || step === Steps.IMPORT_CHOOSE_LENGTH ? "Start Over" : "Back"}
                  </button>

                  {step !== Steps.CREATE_CHOOSE_LENGTH && step !== Steps.IMPORT_CHOOSE_LENGTH && (
                    <button
                      className="sidebar-button"
                      onClick={handleNext}
